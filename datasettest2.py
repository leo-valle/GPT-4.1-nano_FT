...
def convert_excel_to_jsonl(excel_filepath, jsonl_filepath):
    ...
    Assume que o Excel tem as colunas 'Requisito' e 'Categoria'.
    ...
    # Altere os valores abaixo se os nomes das colunas no seu Excel forem diferentes.
    ...
    try:
        ...
        with open(jsonl_filepath, 'w', encoding='utf-8') as f:
            ...
            for index, row in df.iterrows():
                ...
                # Converte o valor numérico da categoria (0 ou 1) para o texto correspondente.
                if category_value == 0:
